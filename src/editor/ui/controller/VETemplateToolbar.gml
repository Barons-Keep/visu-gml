...
show_debug_message("init VETemplateToolbar.gml")


///@static
///@type {?Map<String, Callable>}
global.__VisuTemplateContainers = null///@GMRT
#macro VisuTemplateContainers global.__VisuTemplateContainers
function init_VETemplateToolbar() {
  Core.print("init_VETemplateToolbar")
  VisuTemplateContainers = new Map(String, Callable, {
