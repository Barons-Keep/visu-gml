...
show_debug_message("init template_shader.gml")


///@static
///@type {?Map<String, Callable>}
global.__SHADER_UNIFORM_TEMPLATES = null///@GMRT
#macro SHADER_UNIFORM_TEMPLATES global.__SHADER_UNIFORM_TEMPLATES
function init_SHADER_UNIFORM_TEMPLATES() {
  Core.print("init_SHADER_UNIFORM_TEMPLATES")
  SHADER_UNIFORM_TEMPLATES = new Map(String, Callable)
...
function template_shader(json) {
  ...
  GMArray.forEach(GMArray.sort(shader.uniforms.keys().getContainer()), function(key, index, acc) {
    ...
    var property = Callable.run(SHADER_UNIFORM_TEMPLATES.get(type), uniform, properties, config)
