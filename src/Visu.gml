...
///@type {Number}
global.gamepadPlayerAimMouse = true
...
function _Visu() constructor {
  ...
  particleTemplates = {
    ...
    "particle-hud-point":{
      ...
      "emitter":{
        ...
        "render":true,
        "area":{
          "x":-0.6120000000000001,
          "y":1.5305,
          "z":1.0,
          "a":1.0
        },
        "amount":1.0,
        "distribution":"INVERTEDGAUSSIAN",
        "use":true
      },
      "shape":"RING",
      "scale":{
  ...
  static loadSettings = function() {
    ...
    this.settings.set(new SettingEntry({ name: "visu.interface.player-hint", type: SettingTypes.BOOLEAN, defaultValue: false }))
    this.settings.set(new SettingEntry({ name: "visu.interface.focus-grid", type: SettingTypes.BOOLEAN, defaultValue: false }))
