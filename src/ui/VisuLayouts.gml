...
show_debug_message("init VisuLayouts.gml")
...
global.__VisuLayouts = null///@GMRT
#macro VisuLayouts global.__VisuLayouts
function init_VisuLayouts() {
  Core.print("init_VisuLayouts")
  VisuLayouts = new Map(String, Callable, {
