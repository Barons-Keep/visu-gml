...
show_debug_message("init VEBrushToolbar.gml")
...
global.__VisuBrushContainers = null///@GMRT
#macro VisuBrushContainers global.__VisuBrushContainers
function init_VEBrushToolbar() {
  Core.print("init_VEBrushToolbar")
  VisuBrushContainers = new Map(String, Callable, {
